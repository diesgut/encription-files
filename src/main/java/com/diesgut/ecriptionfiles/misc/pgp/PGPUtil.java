...
public class PGPUtil {
    ...
    public static void encryptFile(OutputStream out, byte[] inptutFile,
    	...
    	Files.write(path, inptutFile);
    	encryptFile(out, fileToEncrypt, encKey, armor, withIntegrityCheck);
    }

    public static void encryptFile(OutputStream out, File inptutFile,
            PGPPublicKey encKey, boolean armor, boolean withIntegrityCheck)
            throws IOException, NoSuchProviderException, PGPException {
        Security.addProvider(new BouncyCastleProvider());
        ...
        org.bouncycastle.openpgp.PGPUtil.writeFileToLiteralData(comData.open(bOut),
                PGPLiteralData.BINARY, inptutFile);
